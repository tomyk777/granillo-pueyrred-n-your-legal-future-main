      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start mb-16">
          <div>
            ...
            <div className="mb-8">
              <h3 className="font-heading text-xl text-accent font-semibold mb-4">Profesionales del Estudio</h3>
              <div className="space-y-3">
                {profesionales.map((p) => (
                  <div
                    key={p.name}
                    className="group flex items-center gap-4 border-l-2 border-primary bg-background/90 px-4 py-3 transition-all duration-300 hover:bg-primary/5 hover:shadow-sm hover:translate-x-1"
                  >
                    ...
                    <p className="font-heading text-accent text-base leading-tight transition-colors duration-300 group-hover:text-primary">{p.name}</p>
                  </div>
                ))}
              </div>
            </div>
