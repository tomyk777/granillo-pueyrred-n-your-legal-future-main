...
const WhatsAppStickyButton = () => {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-[80] inline-flex h-14 w-14 items-center justify-center rounded-full border-2 border-warm-white/70 bg-primary text-primary-foreground shadow-[0_10px_28px_rgba(0,0,0,0.35)] ring-1 ring-charcoal/25 transition-all duration-300 hover:-translate-y-0.5 hover:bg-burgundy-light hover:shadow-[0_14px_34px_rgba(90,10,35,0.45)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-warm-white/80 md:bottom-7 md:right-7"
    >
      <span className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-warm-white/90 text-primary shadow-inner shadow-charcoal/15 transition-colors duration-300 group-hover:bg-warm-white group-hover:text-burgundy-light">
